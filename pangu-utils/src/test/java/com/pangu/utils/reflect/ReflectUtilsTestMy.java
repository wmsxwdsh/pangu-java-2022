package com.pangu.utils.reflect;
 ...
 * @author LZG
 */
public class ReflectUtilsTestMy {
    ...
    public void reflectSetField() {
        ReflectUtils.reflect(ReflectUtilsTestMy.class).field("s1", "world")
                .field("i1", 10);

        // 反射获取 s1
        Object s1Obj = ReflectUtils.reflect(ReflectUtilsTestMy.class).field("s1").get();
        System.out.println(s1Obj.toString());

        //反射获取 i2
        Object i1obj = ReflectUtils.reflect(ReflectUtilsTestMy.class).field("i1").get();
